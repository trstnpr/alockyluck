...
/*
	...
	public function _load_tags(){
		...
		$this->app->set_cdata('title', $tag_name.' Archieves - ' .$this->config_model->get('site_title') );
	...
	public function _load_categories(){
		...
		$this->app->set_cdata('title', $category.' Archieves - ' .$this->config_model->get('site_title') );
		$this->template->render('tags');
	...
	public function _load_author(){
		...
		$this->app->set_cdata('title', $tag_name.', Author at ' .$this->config_model->get('site_title') );
		$this->template->render('tags');
