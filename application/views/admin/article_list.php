	...
	<div class="row">
		...
		<div class="large-12 columns">
			...
			<div style="text-align: right">
				...
				<a href="<?php echo base_url('admin/article/add') ?>" class="button tiny">Add New Post</a>
			...
			<table style="width: 100%">
				...
				<tbody>
					...
					$edit_link = base_url('admin/article/edit/'.$page->id);

					$view_link = base_url($page->permalink);

					$del_link = base_url('admin/article/trash/'.$page->id);
